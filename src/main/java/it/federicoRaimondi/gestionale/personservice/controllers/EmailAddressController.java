...
public class EmailAddressController extends BaseController{
	...
	/**
     * gateway/personservice/emailaddress/store
    ...
    /**
	 * gateway/personservice/emailaddress/storeMap 
	 * Memorizzazione di una risorsa EmailAddressView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/emailaddress/update
     * Aggiorna una risorsa EmailAddressView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/emailaddress/delete
     * Cancellazione di una risorsa EmailAddressView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(EmailAddressView instance) {
     ...
     /**
     * gateway/personservice/emailaddress/delete/{ID}
     * Cancellazione di una risorsa EmailAddressView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/emailaddress/get/{ID}
     * Richiesta di una risorsa EmailAddressView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/emailaddress/getAll
     * Richiesta di tutte le risorse EmailAddressView dal database.
     */
    ...
    /**
     * gateway/personservice/emailaddress/getEmailAddressByID
     * Restituzione di una risorsa in formato Map di EmailAddress
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di EmailAddress", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getEmailAddressByID/{ID}")
	public Map<String, Object> getEmailAddressByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return EmailAddressAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/emailaddress/view/{ID}
     * Richiesta di una risorsa EmailAddressView dal database.
    ...
    /**
     * gateway/personservice/emailaddress/input
     * Richiesta della pagina di inserimento dati di EmailAddressView
     */
	...
	/**
     * gateway/personservice/emailaddress/search
     * Richiesta della pagina di ricerca dati di EmailAddressView
     */
	...
	/**
     * gateway/personservice/emailaddress/storeView
     * Memorizzazione di una risorsa EmailAddressView sul database.
