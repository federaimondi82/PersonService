...
public class CountryController extends BaseController{
	...
	/**
     * gateway/personservice/country/store
    ...
    /**
	 * gateway/personservice/country/storeMap 
	 * Memorizzazione di una risorsa CountryView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/country/update
     * Aggiorna una risorsa CountryView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/country/delete
     * Cancellazione di una risorsa CountryView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(CountryView instance) {
     ...
     /**
     * gateway/personservice/country/delete/{ID}
     * Cancellazione di una risorsa CountryView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/country/get/{ID}
     * Richiesta di una risorsa CountryView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/country/getAll
     * Richiesta di tutte le risorse CountryView dal database.
     */
    ...
    /**
     * gateway/personservice/country/getCountryByID
     * Restituzione di una risorsa in formato Map di Country
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di Country", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getCountryByID/{ID}")
	public Map<String, Object> getCountryByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return CountryAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/country/view/{ID}
     * Richiesta di una risorsa CountryView dal database.
    ...
    /**
     * gateway/personservice/country/input
     * Richiesta della pagina di inserimento dati di CountryView
     */
	...
	/**
     * gateway/personservice/country/search
     * Richiesta della pagina di ricerca dati di CountryView
     */
	...
	/**
     * gateway/personservice/country/storeView
     * Memorizzazione di una risorsa CountryView sul database.
