...
public class SupplierController extends BaseController{
	...
	/**
     * gateway/personservice/supplier/store
    ...
    /**
	 * gateway/personservice/supplier/storeMap 
	 * Memorizzazione di una risorsa SupplierView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/supplier/update
     * Aggiorna una risorsa SupplierView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/supplier/delete
     * Cancellazione di una risorsa SupplierView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(SupplierView instance) {
     ...
     /**
     * gateway/personservice/supplier/delete/{ID}
     * Cancellazione di una risorsa SupplierView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/supplier/get/{ID}
     * Richiesta di una risorsa SupplierView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/supplier/getAll
     * Richiesta di tutte le risorse SupplierView dal database.
     */
    ...
    /**
     * gateway/personservice/supplier/getSupplierByID
     * Restituzione di una risorsa in formato Map di Supplier
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di Supplier", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getSupplierByID/{ID}")
	public Map<String, Object> getSupplierByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return SupplierAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/supplier/view/{ID}
     * Richiesta di una risorsa SupplierView dal database.
    ...
    /**
     * gateway/personservice/supplier/input
     * Richiesta della pagina di inserimento dati di SupplierView
     */
	...
	/**
     * gateway/personservice/supplier/search
     * Richiesta della pagina di ricerca dati di SupplierView
     */
	...
	/**
     * gateway/personservice/supplier/storeView
     * Memorizzazione di una risorsa SupplierView sul database.
