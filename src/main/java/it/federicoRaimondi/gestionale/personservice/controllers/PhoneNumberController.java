...
public class PhoneNumberController extends BaseController{
	...
	/**
     * gateway/personservice/phonenumber/store
    ...
    /**
	 * gateway/personservice/phonenumber/storeMap 
	 * Memorizzazione di una risorsa PhoneNumberView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/phonenumber/update
     * Aggiorna una risorsa PhoneNumberView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/phonenumber/delete
     * Cancellazione di una risorsa PhoneNumberView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(PhoneNumberView instance) {
     ...
     /**
     * gateway/personservice/phonenumber/delete/{ID}
     * Cancellazione di una risorsa PhoneNumberView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/phonenumber/get/{ID}
     * Richiesta di una risorsa PhoneNumberView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/phonenumber/getAll
     * Richiesta di tutte le risorse PhoneNumberView dal database.
     */
    ...
    /**
     * gateway/personservice/phonenumber/getPhoneNumberByID
     * Restituzione di una risorsa in formato Map di PhoneNumber
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di PhoneNumber", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getPhoneNumberByID/{ID}")
	public Map<String, Object> getPhoneNumberByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return PhoneNumberAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/phonenumber/view/{ID}
     * Richiesta di una risorsa PhoneNumberView dal database.
    ...
    /**
     * gateway/personservice/phonenumber/input
     * Richiesta della pagina di inserimento dati di PhoneNumberView
     */
	...
	/**
     * gateway/personservice/phonenumber/search
     * Richiesta della pagina di ricerca dati di PhoneNumberView
     */
	...
	/**
     * gateway/personservice/phonenumber/storeView
     * Memorizzazione di una risorsa PhoneNumberView sul database.
