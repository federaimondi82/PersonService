...
public class AddressController extends BaseController{
	...
	/**
     * gateway/personservice/address/store
    ...
    /**
	 * gateway/personservice/address/storeMap 
	 * Memorizzazione di una risorsa AddressView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/address/update
     * Aggiorna una risorsa AddressView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/address/delete
     * Cancellazione di una risorsa AddressView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(AddressView instance) {
     ...
     /**
     * gateway/personservice/address/delete/{ID}
     * Cancellazione di una risorsa AddressView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/address/get/{ID}
     * Richiesta di una risorsa AddressView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/address/getAll
     * Richiesta di tutte le risorse AddressView dal database.
     */
    ...
    /**
     * gateway/personservice/address/getAddressByID
     * Restituzione di una risorsa in formato Map di Address
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di Address", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getAddressByID/{ID}")
	public Map<String, Object> getAddressByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return AddressAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/address/view/{ID}
     * Richiesta di una risorsa AddressView dal database.
    ...
    /**
     * gateway/personservice/address/input
     * Richiesta della pagina di inserimento dati di AddressView
     */
	...
	/**
     * gateway/personservice/address/search
     * Richiesta della pagina di ricerca dati di AddressView
     */
	...
	/**
     * gateway/personservice/address/storeView
     * Memorizzazione di una risorsa AddressView sul database.
