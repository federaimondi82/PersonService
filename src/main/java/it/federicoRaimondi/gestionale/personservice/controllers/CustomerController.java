...
public class CustomerController extends BaseController{
	...
	/**
     * gateway/personservice/customer/store
    ...
    /**
	 * gateway/personservice/customer/storeMap 
	 * Memorizzazione di una risorsa CustomerView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/customer/update
     * Aggiorna una risorsa CustomerView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/customer/delete
     * Cancellazione di una risorsa CustomerView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(CustomerView instance) {
     ...
     /**
     * gateway/personservice/customer/delete/{ID}
     * Cancellazione di una risorsa CustomerView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/customer/get/{ID}
     * Richiesta di una risorsa CustomerView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/customer/getAll
     * Richiesta di tutte le risorse CustomerView dal database.
     */
    ...
    /**
     * gateway/personservice/customer/getCustomerByID
     * Restituzione di una risorsa in formato Map di Customer
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di Customer", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getCustomerByID/{ID}")
	public Map<String, Object> getCustomerByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return CustomerAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/customer/view/{ID}
     * Richiesta di una risorsa CustomerView dal database.
    ...
    /**
     * gateway/personservice/customer/input
     * Richiesta della pagina di inserimento dati di CustomerView
     */
	...
	/**
     * gateway/personservice/customer/search
     * Richiesta della pagina di ricerca dati di CustomerView
     */
	...
	/**
     * gateway/personservice/customer/storeView
     * Memorizzazione di una risorsa CustomerView sul database.
