...
public class PersonController extends BaseController {
	...
	public String getPersonHome(@PathVariable("userID") Long userID) {
		if (userID == null) {
			return null;
		}
	...
	/**
	 * gateway/personservice/person/store Memorizzazione di una risorsa PersonView sul database.
	 * 
	...
	/**
	 * gateway/personservice/person/storeJson Memorizzazione di una risorsa PersonView sul database.
	 */
	@ApiOperation(value = "Salvataggio di PersonView", response = ResponseEntity.class, produces = "application/json")
	@ApiResponses({ @ApiResponse(code = 200, message = "Salvato correttamente"),
			@ApiResponse(code = 500, message = "Il salvataggio non corretto"),
	...
	public ResponseEntity<?> storeJson(String instance) {
		if (instance == null)
	...
	/**
	 * gateway/personservice/person/update Aggiorna una risorsa PersonView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
	...
	/**
	 * gateway/personservice/person/delete Cancellazione di una risorsa PersonView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
	...
	/**
	 * gateway/personservice/person/delete/{ID} Cancellazione di una risorsa PersonView sul database.
	 * 
	...
	/**
	 * gateway/personservice/person/get/{ID} Richiesta di una risorsa PersonView dal database.
	 * 
	...
	/**
	 * gateway/personservice/person/getAll Richiesta di tutte le risorse PersonView dal database.
	 */
	 ...
	 * </p>
	 */
	@ApiOperation(value = "Restituzione di una risorsa in formato Json di Person", response = ResponseEntity.class, produces = "application/json")
	@ApiResponses({ @ApiResponse(code = 200, message = "Richiesta effettuata con successo"),
			@ApiResponse(code = 500, message = "Richiesta effettuata senza successo"),
			@ApiResponse(code = 401, message = "Non sei autorizzato"),
			@ApiResponse(code = 403, message = "Non sei autenticato") })
	...
	/**
	 * gateway/personservice/person/view/{ID} Richiesta di una risorsa PersonView dal database.
	 * 
	...
	/**
	 * gateway/personservice/person/input Richiesta della pagina di inserimento dati di PersonView
	 */
	...
	/**
	 * gateway/personservice/person/search Richiesta della pagina di ricerca dati di PersonView
	 */
	...
	/**
	 * gateway/personservice/person/storeView Memorizzazione di una risorsa PersonView sul database.
	 * 
