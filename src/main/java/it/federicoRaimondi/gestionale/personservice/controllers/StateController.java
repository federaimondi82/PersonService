...
public class StateController extends BaseController{
	...
	/**
     * gateway/personservice/state/store
    ...
    /**
	 * gateway/personservice/state/storeMap 
	 * Memorizzazione di una risorsa StateView sul database.
	 * 
	 * @param instance l'oggetto passato dal fontend
	 */
    ...
    /**
     * gateway/personservice/state/update
     * Aggiorna una risorsa StateView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    /**
     * gateway/personservice/state/delete
     * Cancellazione di una risorsa StateView sul database.
     * @param instance l'oggetto passato dal fontend
     */
    ...
    public ResponseEntity<?> delete(StateView instance) {
     ...
     /**
     * gateway/personservice/state/delete/{ID}
     * Cancellazione di una risorsa StateView sul database.
    ...
    public ResponseEntity<?> deleteByID(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/state/get/{ID}
     * Richiesta di una risorsa StateView dal database.
    ...
    public ResponseEntity<?> get(@PathVariable("ID") Long ID) {
     ...
     /**
     * gateway/personservice/state/getAll
     * Richiesta di tutte le risorse StateView dal database.
     */
    ...
    /**
     * gateway/personservice/state/getStateByID
     * Restituzione di una risorsa in formato Map di State
     */
    @ApiOperation(value="Restituzione di una risorsa in formato Map di State", response=ResponseEntity.class, produces="application/json")
	@ApiResponses({@ApiResponse(code=200, message="Richiesta effettuata con successo"),
		@ApiResponse(code=500, message="Richiesta effettuata senza successo"),
		@ApiResponse(code=401, message="Non sei autorizzato"),
		@ApiResponse(code=403, message="Non sei autenticato")})
    @GetMapping(value = "/articolo/getStateByID/{ID}")
	public Map<String, Object> getStateByID(@PathVariable("ID") Long ID) {
		if (ID == null)
			return null;
		return StateAdapter.getInstance().adapt(getService().findByID(ID)).toJson();
	}
    ...
    /**
     * gateway/personservice/state/view/{ID}
     * Richiesta di una risorsa StateView dal database.
    ...
    /**
     * gateway/personservice/state/input
     * Richiesta della pagina di inserimento dati di StateView
     */
	...
	/**
     * gateway/personservice/state/search
     * Richiesta della pagina di ricerca dati di StateView
     */
	...
	/**
     * gateway/personservice/state/storeView
     * Memorizzazione di una risorsa StateView sul database.
